function [jaccard_index_in_out_list_bilateral,jaccard_index_in_out_list_all,jaccard_index_in_list_bilateral,jaccard_index_in_list_all] = asymtool_jaccard_1step(A,LRU,is_bilateral,is_all,is_in,is_in_out)

%   1-step Jaccard Index
%
%   asymtool_jaccard_1step calculates the Jaccard similarity coefficient of
%   1step neighborhood. since the network is directed network, neighborhood
