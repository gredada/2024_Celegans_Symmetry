function [redundancy_index_list_bilateral,redundancy_index_list_all] = asymtool_pair_redundancy_index2(A,LRUL,is_bilateral,is_all)
% Calculate pair-redundancy index
...
if is_bilateral
    ...
    for n_bi = 1:length(left_idx_list)
        ...
        if (GE-GE_removeBoth) > 0
            ...
            redundancy_index_list_bilateral(n_bi) = 0;
        end
    end
end
...
%         disp(left_idx);
        for right_idx = left_idx+1:N
            ...
            if (GE-GE_removeBoth) > 0
                ...
                redundancy_index_list_all(n_temp) = 0;
            end
        end
    end
end

redundancy_index_list_bilateral(isnan(redundancy_index_list_bilateral)) = 0;
redundancy_index_list_all(isnan(redundancy_index_list_all)) = 0;
